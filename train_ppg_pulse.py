...
Original file is located at
    https://colab.research.google.com/drive/1b8p2blNi93bPXjMfjKjLQEqG25Fv5_df
"""

# Save this as models/train_ppg_pulse.py
...
WINDOW = 60      # seconds
STRIDE = 30
THRESH = 94      # SpO2 < 94 = stressed (proxy label)
